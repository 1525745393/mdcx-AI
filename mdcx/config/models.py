...
class Config(BaseModel):
    ...
    vsmeta_include_poster: bool = Field(default=True, title="VSMETA嵌入封面图")
    vsmeta_include_backdrop: bool = Field(default=True, title="VSMETA嵌入背景图")
    vsmeta_locked: bool = Field(default=True, title="VSMETA锁定元数据")
    vsmeta_image_max_dimension: int = Field(default=1920, title="VSMETA图片最大尺寸")
