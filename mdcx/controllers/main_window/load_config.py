...
def load_config(self: "MyMAinWindow"):
    ...
    if os.path.exists(config_path):
        ...
        self.Ui.comboBox_vsmeta_show_title.setCurrentIndex(list(VsmetaShowTitle).index(manager.config.vsmeta_show_title))
        self.Ui.comboBox_vsmeta_show_title2.setCurrentIndex(list(VsmetaShowTitle2).index(manager.config.vsmeta_show_title2))
