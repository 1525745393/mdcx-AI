## 220260559 (2026-05-30)

### 新功能和优化
- **VSMETA 实时预览功能完善**：
  - 在配置加载完成后自动初始化预览
  - 在应用预设配置（推荐、高画质、最小文件）时更新预览
  - 在重置默认配置时更新预览
  - 确保用户打开设置界面时就能看到当前配置的预览效果

## 220260558 (2026-05-30)

### 新功能和优化
- **VSMETA 实时预览功能**：
  - 在 VSMETA 设置界面添加实时预览区域
  - 当修改标题、副标题或简介配置时，会即时显示效果预览
  - 使用示例数据展示配置后的 VSMETA 内容外观
  - 帮助用户更直观地理解配置效果

## 220260557 (2026-05-30)

### 新功能和优化
- **VSMETA 内容配置选项大幅扩充**：
  - 标题内容新增选项：仅番号、番号+日文标题、中文+日文标题、日文+中文标题
  - 副标题内容新增选项：制作商+工作室、系列名称、主要演员
  - 简介内容新增选项：中文简介+制作信息、番号+标题

## 220260556 (2026-05-30)

### 新功能和优化
- **VSMETA 设置界面优化（二期）**：
  - JPEG 质量控件优化为滑块，配合数值显示更直观
  - 添加 VSMETA 格式帮助按钮，点击打开 Synology 官方文档
  - 所有预设按钮和重置功能同步支持滑块控件
